...
const VAPID_PUBLIC_KEY = 'BO9ipIooyJdPraRxlA17BOqbfdeEBCDfTxFFCJNqG4VpogEAmQMisamWI9jrhavqRNkiGHGogwaEpL1XiqdeFHo';
...
async function loadContent(page) {
    ...
    } catch { contentDiv.innerHTML = '<p class="is-center text-error">Ошибка загрузки.</p>'; }
}
            ...
            if (enableBtn && disableBtn) {
                ...
                enableBtn.addEventListener('click', async () => {
                    ...
                    if (Notification.permission === 'default') {
                        if ((await Notification.requestPermission()) !== 'granted') { alert('Разрешите уведомления.'); return; }
                    }
