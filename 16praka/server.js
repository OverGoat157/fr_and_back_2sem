...
const vapidKeys = {
    publicKey: 'BO9ipIooyJdPraRxlA17BOqbfdeEBCDfTxFFCJNqG4VpogEAmQMisamWI9jrhavqRNkiGHGogwaEpL1XiqdeFHo',
    privateKey: 'DaubL8nAG9vZ7WWFrmx2E3P3_L3ZIB3Z70YzCHJqYCg'
};
...
app.post('/subscribe', (req, res) => { subscriptions.push(req.body); res.status(201).json({ message: 'Подписка сохранена' }); });
